...
final class ViewContext
{
    ...
    // TODO : renommer en loadHelper() ??? + modifier cela dans la ViewInterface et la nativeview::class
    public function helper(string $alias, string $class): void
    {
        // TODO éventuellement vérifier si il n'y a pas déjà une propriété de classe avec l'alias qui existe car sinon on pourra pas accéder à la propriété. Et faire ce test en vérifiant la case (majuscule/minuscule) voir si ca fonctionne. Par exemple $this->Html fonctionne si on une propriété de classe existante avec $html en minuscule ????
     ...
     * @return bool
     */
    // TODO : si on garde cette méthode il faudra créer une méthode proxy dans la classe View pour récupérer ces informations histoire de pouvoir les utiliser dans les controllers par exemple + mettre à jour la classe ViewInterface pour ajouter la signature !!!!
    /*
